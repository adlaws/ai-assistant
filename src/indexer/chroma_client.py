...
class ChromaClient:
    ...
    def __init__(self, collection_name: str, embedding_model: Optional[str] = None, db_path: Optional[str] = None, create_if_missing: bool = False) -> None:
    ...
    def create_client(self, db_path: Optional[str] = None) -> ChromaClient:
